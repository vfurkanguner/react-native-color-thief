...
describe('ReactNativeColorThief', () => {
    ...
    for (let i = 0; i < 10000; i++) {
      ...
      switch (colorIndex) {
        case 0:
          ...
          break;
        case 1:
          pixelData[offset] = 51; pixelData[offset + 1] = 255; pixelData[offset + 2] = 87; pixelData[offset + 3] = 255; // Green
          break;
        case 2:
          pixelData[offset] = 87; pixelData[offset + 1] = 51; pixelData[offset + 2] = 255; pixelData[offset + 3] = 255; // Blue
          break;
        case 3:
          pixelData[offset] = 255; pixelData[offset + 1] = 255; pixelData[offset + 2] = 51; pixelData[offset + 3] = 255; // Yellow
          break;
        case 4:
  ...
  describe('Constructor', () => {
    it('should create instance with default config', () => {
      const instance = new ReactNativeColorThief();
    ...
    it('should create instance with custom config', () => {
      const customConfig: ColorThiefConfig = {
        quality: 5,
        colorCount: 8,
        minAlpha: 100,
        excludeWhite: false,
    ...
    it('should merge partial config with defaults', () => {
      const partialConfig: ColorThiefConfig = {
        quality: 7,
        colorCount: 3,
      };

      const instance = new ReactNativeColorThief(partialConfig);
      const config = instance.getConfig();
...
describe('Factory Functions and Legacy Support', () => {
  describe('createColorThief', () => {
    it('should create ColorThief instance with default config', () => {
      const instance = createColorThief();
      expect(instance).toBeInstanceOf(ReactNativeColorThief);
    ...
    it('should create ColorThief instance with custom config', () => {
      ...
      const instance = createColorThief(customConfig);
  ...
  describe('defaultColorThief', () => {
    it('should be a ReactNativeColorThief instance', () => {
      expect(defaultColorThief).toBeInstanceOf(ReactNativeColorThief);
    });

    it('should have default configuration', () => {
      const config = defaultColorThief.getConfig();
      expect(config.quality).toBe(10);
      expect(config.colorCount).toBe(5);
    });
  });
  ...
  describe('getProminentColors (legacy)', () => {
    beforeEach(() => {
      ...
      for (let i = 0; i < 1000; i++) {
        ...
        switch (colorIndex) {
          case 0:
            pixelData[offset] = 255; pixelData[offset + 1] = 87; pixelData[offset + 2] = 51; pixelData[offset + 3] = 255;
            break;
          case 1:
            pixelData[offset] = 51; pixelData[offset + 1] = 255; pixelData[offset + 2] = 87; pixelData[offset + 3] = 255;
            break;
          case 2:
            pixelData[offset] = 87; pixelData[offset + 1] = 51; pixelData[offset + 2] = 255; pixelData[offset + 3] = 255;
            break;
        }
      }
    ...
    it('should return array of hex strings', async () => {
      const colors = await getProminentColors('https://example.com/image.jpg');
    ...
    it('should work with different image URLs', async () => {
      const colors = await getProminentColors('https://example.com/different-image.png');
