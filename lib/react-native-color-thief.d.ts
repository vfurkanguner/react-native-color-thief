import { ArrayRGB, ColorFormats } from "./color-converters";
import { FullCompatibilityResult } from "./version-compatibility";
/**
 ...
 */
export declare class ReactNativeColorThief {
     ...
     * ```
     */
    getProminentColors(sourceURI: string): Promise<ColorResult[]>;
    /**
     ...
     * ```
     */
    getPalette(sourceURI: string): Promise<PaletteResult>;
    /**
     ...
     * ```
     */
    getDominantColor(sourceURI: string): Promise<ColorResult>;
    /**
     ...
     * ```
     */
    getColorsInFormat(sourceURI: string, format: ColorFormats): Promise<string[]>;
    /**
     ...
     * ```
     */
    updateConfig(newConfig: Partial<ColorThiefConfig>): void;
    /**
     ...
     * ```
     */
    isSupportedFormat(sourceURI: string): boolean;
    /**
     ...
     * ```
     */
    checkVersionCompatibility(): FullCompatibilityResult;
    /**
     ...
     * ```
     */
    getColorStatistics(sourceURI: string): Promise<{
        totalColors: number;
 ...
 * ```
 */
export declare const createColorThief: (config?: ColorThiefConfig) => ReactNativeColorThief;
/**
 ...
 * ```
 */
export declare const defaultColorThief: ReactNativeColorThief;
/**
 ...
 * ```
 */
export declare const getProminentColors: (sourceURI: string) => Promise<string[]>;
export { checkCompatibility, logCompatibilityStatus, getRecommendedSkiaVersion, supportsVideoFeatures, parseVersion, compareVersions, getPackageVersion } from './version-compatibility';
